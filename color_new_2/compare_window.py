...
class CompareWindow:
    ...
    def setup_window(self):
        ...
        ttk.Button(control_frame, text="Run Full Comparison", 
                  command=self.run_full_comparison).pack(side=tk.LEFT, padx=5)
    ...
    def run_full_comparison(self):
        """Run both algorithms from scratch"""
        self.progress.start()
        self.results_text.delete(1.0, tk.END)
        self.results_text.insert(tk.END, "Running full comparison...\n")
    ...
    def _update_display(self):
        ...
        for algo, result in self.results.items():
            ...
            if algo == 'cultural' and 'log' in result and result['log']:
                self.results_text.insert(tk.END, f"  Progress Log (last 10):\n")
                for log_msg in result['log'][-10:]:
